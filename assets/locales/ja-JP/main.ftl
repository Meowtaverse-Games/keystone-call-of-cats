...
stage-ui-status-run = メニュー「実行（F1）」を選択しました。
stage-ui-status-stop = メニュー「停止（F1）」を選択しました。
stage-ui-status-font-decrease = メニュー「-（F2）」を選択しました。
stage-ui-status-font-increase = メニュー「+（F3）」を選択しました。
